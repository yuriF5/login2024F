        ...
        <div class="confirm-table">
          <table class="confirm-table__inner">
            <tr class="confirm-table__row">
              ...
              <td class="confirm-table__text">
                <input type="text" name="last_name" value="{{ $contact['first_name'] }}"readonly />
              </td>
            </tr>
            <tr class="confirm-table__row">
            ...
            <tr class="confirm-table__row">
              <th class="confirm-table__header">お問い合わせ種類</th>
                <td class="confirm-table__text">
                  <input type="hidden" name="content" value="{{ $category['content'] }}"readonly />
                  <?php
                  if ($category['content'] == '1') {
                  echo '商品のお届けについて';} else if ($category['content'] == '2') {
                  echo '商品の交換について';} else if ($category['content'] == '3') {
                  echo '商品トラブル';}else if ($category['content'] == '4') {
                  echo 'ショップへのお問い合わせ';} else if ($category['content'] == '5') {
                  echo 'その他';} 
                  ?>
                </td>
            </tr>
